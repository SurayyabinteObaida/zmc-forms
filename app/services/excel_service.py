...
ALL_COLUMNS = [
    ...
    ("PRINTING TYPE",             "printing_type",   14),
    ("PRINT DATE",                "date",            12),
    ...
    ("PLAIN WT.",                 "net_wt",          10),
    ("PRINTED WT.",               "printed_reel_wt", 12),
    ("SIZE IN MM",                "size_mm",         12),
    ("DENSITY",                   "density",         10),
    ("WT. GAIN",                  "wt_gain",         10),
    ("WT. GAIN %",                "wt_gain_pct",     10),
    ("Printed WASTAGE",           "printed_waste",   14),
    ("PLAIN WASTAGE",             "plain_waste",     14),
    ("METER/COUNTER",             "meter_counter",   14),
    ("WASTAGE IN %",              "wastage_pct",     12),
    ("GSM",                       "gsm",             10),
    ("CALCULATED METERS",         "calc_meters",     18),
    ("NO. OF ROllS",              "no_of_rolls",     12),
    ("SHIFT",                     "shift",           10),
    ("OPERATOR",                  "operator",        12),
    ("SETTING TIME",              "setting_time",    12),
    ("START TIME",                "start_time",      10),
    ("END TIME",                  "end_time",        10),
    ("MACHINE RUN TIME",          "run_time",        16),
    ("Run Hrs (24H)",             "run_hrs",         12),
    ("AVERAGE ACTUAL SPEED",      "avg_speed",       18),
    ("NO. OF TIME MACHINE STOP",  "machine_stops",   22),
    ("JOB STATUS",                "job_status",      12),
    ("REMARKS",                   "remarks",         12),
]
