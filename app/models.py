...
class LaminationRecord(db.Model):
    """Permanent typed storage for verified Lamination records."""
    __tablename__ = "lamination_records"
    ...
    film_a = db.Column(db.String(200))
    film_a_size_micron = db.Column(db.String(200))
    film_b = db.Column(db.String(200))
    film_b_size_micron = db.Column(db.String(200))
    glue_coating_size = db.Column(db.String(100))
    total_printed_film_qty = db.Column(db.Float)
    printed_wastage = db.Column(db.Float)
    total_film_b_qty = db.Column(db.Float)
    film_b_wastage = db.Column(db.Float)
    total_order_qty = db.Column(db.Float)
    total_laminated_qty = db.Column(db.Float)
    job_status = db.Column(db.String(100))
    total_laminated_meters = db.Column(db.Float)
    laminated_wastage = db.Column(db.Float)
    glue_ratio = db.Column(db.String(100))
    glue_type = db.Column(db.String(100))
    hardner = db.Column(db.Float)
    resin = db.Column(db.Float)
    glue_consumption_no_solvent = db.Column(db.Float)
    a_component_resin = db.Column(db.Float)
    b_component_hardner = db.Column(db.Float)
    ethyl_acetate = db.Column(db.Float)
    total_batch_qty = db.Column(db.Float)
    a_resin_consumption = db.Column(db.Float)
    b_hardner_consumption = db.Column(db.Float)
    ea_consumption = db.Column(db.Float)
    a_resin_rate = db.Column(db.Float)
    b_hardner_rate = db.Column(db.Float)
    ea_rate = db.Column(db.Float)
    a_cost = db.Column(db.Float)
    b_cost = db.Column(db.Float)
    c_cost = db.Column(db.Float)
    total_cost = db.Column(db.Float)
    glue_cost_per_kg = db.Column(db.Float)
    remarks = db.Column(db.Text)


class SlittingRecord(db.Model):
    """Permanent typed storage for verified Slitting records."""
    __tablename__ = "slitting_records"
    ...
    job_name = db.Column(db.String(200))
    structure = db.Column(db.String(200))
    overall_mic = db.Column(db.String(100))
    slitting_size = db.Column(db.String(100))
    outter_dia = db.Column(db.String(100))
    inner_dia = db.Column(db.String(100))
    start_time = db.Column(db.String(100))
    end_time = db.Column(db.String(100))
    operator = db.Column(db.String(200))
    shift = db.Column(db.String(50))
    total_mother_reels = db.Column(db.Float)
    total_slitted_reels = db.Column(db.Float)
    single_slitted_reel_wt = db.Column(db.Float)
    slitted_reel_wt = db.Column(db.Float)
    mother_reel_wt = db.Column(db.Float)
    setting_wastage = db.Column(db.Float)
    trim_waste = db.Column(db.Float)
    trim_size = db.Column(db.String(100))
    remarks = db.Column(db.Text)